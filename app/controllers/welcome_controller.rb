class WelcomeController < ApplicationController
  # by default all actions will render with views/layout/applications.html.erb unless you specify something like:
  # layout "special"
  # by convention the line above will use: views/layout/special.html.erb
